...
setClass(
  "stringkernel",prototype = structure(
    .Data = function() {
    },kpar = list(
      length = 4, lambda = 1.1, type = "spectrum", normalized = TRUE
    )
  ),contains = c("kernel")
)

stringdot <-
  function(length = 4, lambda = 1.1, type = "spectrum", normalized = TRUE)
  {
    type <-
      match.arg(
        type,c(
          "sequence","string","fullstring","exponential","constant","spectrum", "boundrange"
        )
      )
    ...
    switch(
      ...
      "sequence" = {
        rval <- function(x, y = NULL)
        {
          ...
          if (is(x,"vector") &&
              is.null(y) && normalized == FALSE)
            return(
              .Call(
                "subsequencek",as.character(x), as.character(x), as.integer(nchar(x)), as.integer(nchar(x)), as.integer(length), as.double(lambda),PACKAGE = "KERE"
              )
            )
          if (is(x,"vector") &&
              is(y,"vector") && normalized == FALSE)
            return(
              .Call(
                "subsequencek",as.character(x), as.character(y), as.integer(nchar(x)), as.integer(nchar(y)), as.integer(length), as.double(lambda),PACKAGE = "KERE"
              )
            )
          if (is(x,"vector") &&
              is.null(y) && normalized == TRUE)
            return(1)
          if (is(x,"vector") &&
              is(y,"vector") && normalized == TRUE)
            return(
              .Call(
                "subsequencek",as.character(x), as.character(y), as.integer(nchar(x)), as.integer(nchar(y)), as.integer(length), as.double(lambda),PACKAGE = "KERE"
              ) / sqrt(
                .Call(
                  ...
                  "subsequencek",as.character(y), as.character(y), as.integer(nchar(y)), as.integer(nchar(y)), as.integer(length), as.double(lambda),PACKAGE = "KERE"
                )
              )
            )
        }
      ...
      "exponential" = {
        rval <- function(x,y = NULL)
        {
          ...
          if (normalized == FALSE) {
            ...
            return(
              .Call(
                "stringtv",as.character(x),as.character(y),as.integer(1),as.integer(nchar(x)),as.integer(nchar(y)),as.integer(2),as.double(lambda)
              )
            )
          }
          if (is(x,"vector") &&
          ...
          if (is(x,"vector") &&
            ...
            return(
              .Call(
                ...
                .Call(
                  "stringtv",as.character(x),as.character(x),as.integer(1),as.integer(nchar(x)),as.integer(nchar(x)),as.integer(2),as.double(lambda)
                ) * .Call(
                  "stringtv",as.character(y),as.character(y),as.integer(1),as.integer(nchar(y)),as.integer(nchar(y)),as.integer(2),as.double(lambda)
                )
              )
            )
      ...
      "constant" = {
        rval <- function(x,y = NULL)
        {
          ...
          if (normalized == FALSE) {
            ...
            return(
              .Call(
                "stringtv",as.character(x),as.character(y),as.integer(1),as.integer(nchar(x)),as.integer(nchar(y)),as.integer(1),as.double(lambda)
              )
            )
          }
          if (is(x,"vector") &&
          ...
          if (is(x,"vector") &&
            ...
            return(
              .Call(
                ...
                .Call(
                  "stringtv",as.character(x),as.character(x),as.integer(1),as.integer(nchar(x)),as.integer(nchar(x)),as.integer(1),as.double(lambda)
                ) * .Call(
                  "stringtv",as.character(y),as.character(y),as.integer(1),as.integer(nchar(y)),as.integer(nchar(y)),as.integer(1),as.double(lambda)
                )
              )
            )
        }
      ...
      "spectrum" = {
        rval <- function(x,y = NULL)
        {
          ...
          if (normalized == FALSE) {
            ...
            return(
              .Call(
                "stringtv",as.character(x),as.character(y),as.integer(1),as.integer(n),as.integer(m),as.integer(3),as.double(length)
              )
            )
          }
          if (is(x,"vector") &&
          ...
          if (is(x,"vector") &&
            ...
            return(
              .Call(
                ...
                .Call(
                  "stringtv",as.character(x),as.character(x),as.integer(1),as.integer(n),as.integer(n),as.integer(3),as.double(lambda)
                ) * .Call(
                  "stringtv",as.character(y),as.character(y),as.integer(1),as.integer(m),as.integer(m),as.integer(3),as.double(length)
                )
              )
            )
      ...
      "boundrange" = {
        rval <- function(x,y = NULL)
        {
          ...
          if (normalized == FALSE) {
            ...
            return(
              .Call(
                "stringtv",as.character(x),as.character(y),as.integer(1),as.integer(nchar(x)),as.integer(nchar(y)),as.integer(4),as.double(lambda)
              )
            )
          }
          if (is(x,"vector") &&
          ...
          if (is(x,"vector") &&
            ...
            return(
              .Call(
                ...
                .Call(
                  "stringtv",as.character(x),as.character(x),as.integer(1),as.integer(nchar(x)),as.integer(nchar(x)),as.integer(4),as.double(lambda)
                ) * .Call(
                  "stringtv",as.character(y),as.character(y),as.integer(1),as.integer(nchar(y)),as.integer(nchar(y)),as.integer(4),as.double(lambda)
                )
              )
            )
      ...
      "string" =
      {
        rval <- function(x, y = NULL)
        {
          ...
          if (is(x,"vector") &&
            ...
            return(
              .Call(
                "substringk",as.character(x), as.character(x), as.integer(nchar(x)), as.integer(nchar(x)), as.integer(length), as.double(lambda),PACKAGE = "KERE"
              )
            )
          ...
          if (is(x,"vector") &&
            ...
            return(
              .Call(
                "substringk",as.character(x), as.character(y), as.integer(nchar(x)), as.integer(nchar(y)), as.integer(length), as.double(lambda),PACKAGE = "KERE"
              )
            )
          if (is(x,"vector") &&
              is.null(y) && normalized == TRUE)
            ...
            return(
              .Call(
                ...
                .Call(
                  ...
                  "substringk",as.character(y), as.character(y), as.integer(nchar(y)), as.integer(nchar(y)), as.integer(length), as.double(lambda),PACKAGE = "KERE"
                )
              )
            )
        }
      ...
      "fullstring" =
      {
        rval <- function(x, y = NULL)
        {
          ...
          if (is(x,"vector") &&
            ...
            return(
              .Call(
                "fullsubstringk",as.character(x), as.character(x), as.integer(nchar(x)), as.integer(nchar(x)), as.integer(length), as.double(lambda),PACKAGE = "KERE"
              )
            )
          ...
          if (is(x,"vector") &&
            ...
            return(
              .Call(
                "fullsubstringk",as.character(x), as.character(y), as.integer(nchar(x)), as.integer(nchar(y)), as.integer(length), as.double(lambda),PACKAGE = "KERE"
              )
            )
          if (is(x,"vector") &&
              is.null(y) && normalized == TRUE)
            ...
            return(
              .Call(
                ...
                .Call(
                  ...
                  "fullsubstringk",as.character(y), as.character(y), as.integer(nchar(y)), as.integer(nchar(y)), as.integer(length), as.double(lambda),PACKAGE = "KERE"
                )
              )
            )
        }
    ...
    return(new(
      "stringkernel",.Data = rval,kpar = list(
        length = length, lambda = lambda, type = type, normalized = normalized
      )
    ))
  }
...
setMethod("show",signature(object = "kernel"),
          function(object)
          {
            switch(
              ...
              "stringkernel" = {
                if (kpar(object)$type == "spectrum" |
                    kpar(object)$type == "boundrange")
                  cat(
                    paste(
                      "String kernel function.", " Type = ", kpar(object)$type, "\n","Hyperparameters :","sub-sequence/string length = ",kpar(object)$length, "\n"
                    )
                  )
                else
                  if (kpar(object)$type == "exponential" |
                      kpar(object)$type == "constant")
                    cat(
                      paste(
                ...
                if (kpar(object)$normalized == TRUE)
                  cat(" Normalized","\n")
                if (kpar(object)$normalized == FALSE)
                  cat(" Not Normalized","\n")
              }
            )
          })
...
kernelMatrix.stringkernel <- function(kernel, x, y = NULL)
{
  ...
  if (kpar(kernel)$type == "sequence" |
      kpar(kernel)$type == "string" | kpar(kernel)$type == "fullstring")
  {
    resdiag <- rep(0,n)
    if (normalized == TRUE)
      kernel <-
        stringdot(
          length = kpar(kernel)$length, type = kpar(kernel)$type, lambda = kpar(kernel)$lambda, normalized = FALSE
        )
    ## y is null
    ...
    if (sktype == 3 &
        (any(nchar(x) < kpar(kernel)$length) |
         any(nchar(x) < kpar(kernel)$length)))
    ...
    if (is.null(y)) {
      for (i in 1:length(x))
        ret[i,i:length(x)] <-
          .Call(
            "stringtv",as.character(x[i]),as.character(x[i:length(x)]),as.integer(length(x) - i + 1),as.integer(nchar(x[i])),as.integer(nchar(x[i:length(x)])),as.integer(sktype),as.double(kpar(kernel)$lambda)
          )
      ret <- ret + t(ret)
      diag(ret) <- diag(ret) / 2
    }
      ...
      for (i in 1:length(x))
        ret[i,] <-
      .Call(
        "stringtv",as.character(x[i]),as.character(y),as.integer(length(y)),as.integer(nchar(x[i])),as.integer(nchar(y)),as.integer(sktype),as.double(kpar(kernel)$lambda)
      )
    
    if (normalized == TRUE) {
      if (is.null(y))
        ret <- t((1 / sqrt(diag(ret))) * t(ret * (1 / sqrt(diag(
          ret
        )))))
      else{
        ...
        for (i in 1:length(x))
          norm1[i] <-
          .Call(
            "stringtv",as.character(x[i]),as.character(x[i]),as.integer(1),as.integer(nchar(x[i])),as.integer(nchar(x[i])),as.integer(sktype),as.double(kpar(kernel)$lambda)
          )
        for (i in 1:length(y))
          norm2[i] <-
          .Call(
            "stringtv",as.character(y[i]),as.character(y[i]),as.integer(1),as.integer(nchar(y[i])),as.integer(nchar(y[i])),as.integer(sktype),as.double(kpar(kernel)$lambda)
          )
        ...
        kpar(kernel)$type == "string" | kpar(kernel)$type == "fullstring")
    {
      ...
      if (is.null(y)) {
        if (normalized == TRUE) {
          z <- as.matrix(z)
          if (dim(z)[1] != n)
            stop("z rows must be equal to x length")
          dz <- dim(z)[2]
          vres <- matrix(0,n,dz)
          ## calculate diagonal elements first, and use them to normalize
          for (i in 1:n)
      ...
      if (!is.null(y)) {
        if (normalized == TRUE) {
          ...
          z <- as.matrix(z)
          if (dim(z)[1] != m)
            stop("z rows must be equal to y length")
          resdiag1 <- rep(0,m)
          dz <- dim(z)[2]
          vres <- matrix(0,n,dz)
          ...
          if (nblocks > 0) {
            ...
            for (k in 1:nblocks) {
              ...
              for (i in lowerl:(upperl)) {
                for (j in 1:m) {
                  res1[i - (k - 1) * blocksize,j] <-
                    kernel(x[[i]],y[[j]]) / sqrt(resdiag[i] * resdiag1[j])
                }
              }
            ...
            for (k in 1:nblocks) {
              ...
              for (i in lowerl:(upperl)) {
                res1[i - (k - 1) * blocksize,] <-
                  .Call(
                    "stringtv",as.character(x[i]),as.character(x),as.integer(length(x)),as.integer(nchar(x[i])),as.integer(nchar(x)),as.integer(sktype),as.double(kpar(kernel)$lambda)
      ...
      kpar(kernel)$type == "string" | kpar(kernel)$type == "fullstring")
  {
    if (is.null(y)) {
      if (normalized == TRUE) {
        ...
        for (i in 1:n) {
          for (j in (i:n)[-1]) {
            res1[i,j]  <-
              (z[i,] * kernel(x[[i]],x[[j]]) * z[j,]) / sqrt(resdiag[i] * resdiag[j])
          }
        }
        res1 <- res1 + t(res1)
        diag(res1) <- z ^ 2
    ...
    if (!is.null(y)) {
      if (normalized == TRUE) {
        ...
        for (i in 1:n) {
          for (j in 1:m) {
            res1[i,j] <-
              (z[i,] * kernel(x[[i]],y[[j]]) * k[j,]) / sqrt(resdiag[i] * resdiag1[j])
          }
        }
      }
    }
    ...
    if (is.null(y)) {
      ...
      for (i in 1:length(x))
        ret[i,] <-
          .Call(
            "stringtv",as.character(x[i]),as.character(y),as.integer(length(x)),as.integer(nchar(x[i])),as.integer(nchar(y)),as.integer(sktype),as.double(kpar(kernel)$lambda)
          )
      res1 <- k * ret * z
    }
    if (normalized == TRUE) {
